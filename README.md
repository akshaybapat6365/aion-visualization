...
This project includes five interactive visualizations and two reference guides:
...
5. **Archetype Network** - Force-directed graph exploring relationships among Self, Shadow, Anima/Animus and Trickster.
6. **Key Concepts** - Concise explanations of the Self, Shadow, Anima/Animus and Trickster archetypes.
7. **Chapter Guide** - Summaries of the opening chapters of *Aion* for quick orientation.
...
- Animated starfield background on every page (disabled for reduced-motion users)
