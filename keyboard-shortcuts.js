...
class KeyboardShortcuts {
    ...
    navigateToChapter(number) {
        window.location.href = `chapter${number}-v2.html`;
    }
    ...
    goToChapters() {
        window.location.href = 'chapters-v2.html';
    }
    
    openTimeline() {
        window.location.href = 'timeline-v2.html';
    }
    
    openSymbols() {
        window.location.href = 'symbols-v2.html';
    }
    
    openAbout() {
        window.location.href = 'about-v2.html';
    }
